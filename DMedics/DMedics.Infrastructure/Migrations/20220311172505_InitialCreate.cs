        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TypeTitle = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    TypeDescription = table.Column<string>(type: "TEXT", maxLength: 250, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ClinicId = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ClinicName = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    ClinicEmail = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    ClinicPhoneNumber = table.Column<string>(type: "TEXT", maxLength: 15, nullable: false),
                    ClinicPostCode = table.Column<string>(type: "TEXT", maxLength: 10, nullable: false),
                    ClinicAddress = table.Column<string>(type: "TEXT", maxLength: 250, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReferralSource = table.Column<string>(type: "TEXT", maxLength: 250, nullable: false)
                },
                constraints: table =>
                {
